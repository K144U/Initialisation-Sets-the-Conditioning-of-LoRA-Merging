...
the ratio $\E_{P^\star}[\max_t D_t(w^\star)] / (c_{\mathrm{TQ}} B^2
2^{-2R/(Tr)})$ of empirical upper bound to the Stiefel lower bound at
$c_{\mathrm{TQ}} = 1$. The ratio is constant in $R$ (a necessary
