...
\emph{A worked example.} Consider a Llama-3-8B base model with
...
\S\ref{sec:exp} reports synthetic experiments on rank-$r$
LoRA-like ensembles validating the theoretical slopes and
constants. \S\ref{sec:discussion} discusses extensions to
cross-entropy loss, the open shared-$V$ exponent gap, and
implications for practical merging algorithm design.
