...
reading was the best of three draws. Two details we report rather than
absorb: the rank-$64$ realisation disagrees at $T=3$, keeping Llama at
...
only two of the six quantizer widths sit above the metric's own noise
...
three bits upward, so a practitioner quantizing a merged adapter can stop
