...
our lower bound are compatible and, in fact, mutually
reinforcing: the lower bound explains \emph{why} generic
subspace alignment is insufficient when the floor term is
bounded away from zero (irreducible multi-task tension), and
identifies the floor-zero regime in which constructive methods
(ours, and potentially refined versions of TVQ or KnOTS) can
approach the fundamental limit. Fully characterizing the
floor-positive regime remains open
