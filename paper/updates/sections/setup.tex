...
% =========================================================
% CHANGED 2026-05-03 (Garg comment C6): the next paragraph and
% the Problem 1 environment are NEW in this revision. The
% transition sentence and the entire problem block are wrapped
% in red so reviewers can see the addition.
% =========================================================
\new{With the figure of merit, admissibility constraints, and code
