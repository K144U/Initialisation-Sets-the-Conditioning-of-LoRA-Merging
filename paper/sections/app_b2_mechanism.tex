...
task-vector quantisation often outperforms higher bit budgets at
...
quantisation implicitly induces sparsity, playing the same role as
TIES's explicit magnitude trimming. The authors pre-registered two falsifiable
...
\textsc{rejected}.} $b=2$ quantisation does induce substantial implicit
sparsity: $50\%$ of coordinates land in the zero bucket, and
quantisation error exceeds the original magnitude for $\sim 87\%$ of
coordinates. To test whether sparsity drives the dip, the authors built an
...
quantiser pulls the largest coefficients toward the surviving bucket
