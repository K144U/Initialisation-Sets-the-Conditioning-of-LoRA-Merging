...
every geometric quantity at both. Appendix~\ref{app:prereg} summarises all ten
pre-registrations and gives the commit ordering that makes them checkable;
the documents themselves are in the supplementary material.
