...
that. \S\ref{sec:theory} states the bound, says what it did and did not do,
and sends the formal development to Appendix~\ref{app:rd}. In short: its floor
...
(\S\ref{subsec:q1}). The rate exponent the bound predicts is unresolved:
