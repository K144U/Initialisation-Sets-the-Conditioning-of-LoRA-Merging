...
min $0.867$, $0/112$ layers below the pre-registered $0.8$
...
network. (We confirmed the same null on Llama-3.2-3B at $r=64$ as
a cross-architecture check, with $d_{\mathrm{eff}}/(Tr) = $ \textsc{TODO:
fill from arm 3b job 41563}.)
