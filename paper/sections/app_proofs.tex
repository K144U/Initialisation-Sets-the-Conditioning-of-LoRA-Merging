...
earlier version of this work stated that they were in supplementary material;
no such material existed, and we correct that here.
...
subproblem is rate-$R$ quantization of $\eta$ under squared error.
...
against the $\boldsymbol H$-aware decoder of \S\ref{sec:achv}: we do not
...
\paragraph{The constant, isolated.} Writing the entropy power of $\eta$ as a
...
\paragraph{Honest scope.} With that caveat, Theorem~\ref{thm:general} should
