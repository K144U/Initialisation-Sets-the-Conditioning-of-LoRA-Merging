...
per-cell result files are released at \href{\repourl}{\texttt{\repohost}}. The
...
asking the reader to verify rather than accept. The base model weights and
the trained adapters are not redistributed: the bases are public
checkpoints, and the adapter training configurations, including every
seed, are in the repository.
