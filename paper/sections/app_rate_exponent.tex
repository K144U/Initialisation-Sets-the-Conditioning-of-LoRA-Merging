\S\ref{subsec:w3} reports that the authors' rate sweep cannot measure the exponent
...
and $|\mathrm{slope}| < 0.5$ on three of four for it to stand. The authors obtain
one and zero, so the outcome is \textsc{unresolved}. The authors apply the rule to
