...
system in a curvature surrogate, which is exactly the family that
\S\ref{subsec:ridge} finds is sensitive to cohort conditioning, and all of
them carry a ridge term whose role that section is about. We do not
benchmark against RegMean in this version: an earlier draft did, on the
shared-initialisation cohort, and \S\ref{subsec:q1} is the reason those
comparisons are not carried over.
