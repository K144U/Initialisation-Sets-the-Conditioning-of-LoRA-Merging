...
make no priority claim for the lens itself. Where ours differs
technically is that it bounds \emph{worst-task} rather than average
distortion, for rank-$r$ adapters with arbitrary task-dependent
curvature, with a matching construction in the generic regime. We list
the difference for the reader's orientation and not as a contribution
claim; see \S\ref{sec:discussion} for what we think the bound is
actually worth.
