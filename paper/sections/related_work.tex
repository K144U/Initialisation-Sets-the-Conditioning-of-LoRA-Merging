...
regime. We have not attempted to reconcile the two bounds, which are
stated over different objects, and a reader interested in the limits of
merging should read both.
