...
code-analysis adapters~\cite{pathak2026merging}. What unifies these
...
than as a defensive shrinkage on the Gram. We benchmark against a
\emph{data-free} variant of RegMean in
\S\ref{subsec:exp-e10-e11} (it uses $A_t^\top A_t$ as the per-task
Gram surrogate); the full data-dependent RegMean is structurally
closer to LoRM and out of scope for a data-free baseline.
