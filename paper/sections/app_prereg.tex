...
Ten documents govern the tests in this paper. Table~\ref{tab:prereg-docs}
...
afterwards. Earlier versions of this paper reproduced all ten verbatim in
...
altered across the ten: the first document records the wall-clock time at
