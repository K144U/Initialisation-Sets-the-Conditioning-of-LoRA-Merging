...
\subsection{What the authors measure about \texorpdfstring{$A$}{A}, and what they do
not}
\label{subsec:drift}
...
mechanism of \S\ref{subsec:mechanism} is stated in terms of the one the authors do
\emph{not} measure.
...
(\S\ref{subsec:scope}) but which the authors did not predict and do not build on.
