...
describing $\boldsymbol\tau$ are charged to the rate. The authors' lower bound holds
...
its scale is pinned by $\tau_t^\top H_t \tau_t = B^2$. What the authors do not establish
...
(the authors use $c = 5$); total rate $R = b\deff$. \emph{Decoder:} invert each
