...
Drift across training (App.~\ref{subsec:drift-result}) & \texttt{934370a} &
  \texttt{0c02e87} & \texttt{f240c62} \\
\bottomrule
\end{tabular}
\end{table}
...
\item \textbf{\texttt{prereg\_drift}} (\texttt{934370a}) discharges E3,
...
\texttt{prereg\_drift} & \texttt{934370a} & how far $A$ travels (E3) \\
\bottomrule
\end{tabular}
\end{table}
