...
the refit of \S\ref{subsec:w3}. The authors applied the three branches to the
...
because both cut against the authors. The gate is \emph{binomial} rather than the
