...
\emph{Computational experiments, items 1 and 4: which clause the authors satisfy.} They
...
the released history with \texttt{git merge-base}. Several of the authors' own earlier
