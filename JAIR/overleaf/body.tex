...
\ifdefined\TopmatterAlreadySet\else
\maketitle
...
% JAIR is biblatex/biber (jair.cls loads acmart with natbib=false), so it needs
% \printbibliography and has already done \addbibresource in the root. The
% other three roots are natbib/BibTeX and need this line.
\ifdefined\TopmatterAlreadySet
\printbibliography
\else
