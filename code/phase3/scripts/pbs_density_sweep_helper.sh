...
#PBS -N rdm_denshlp
#PBS -q gpu
#PBS -l select=1:ncpus=4:mem=48gb:host=jiit-gpu01
...
export ORCH_SENTINEL=_DENSITY_HELPER_COMPLETE
export ORCH_STATE=orchestrator_state_density_helper.json
export GPUS=0,1,3

MANIFEST="${MANIFEST:-code/phase3/configs/density_sweep_manifest_rev.json}"
